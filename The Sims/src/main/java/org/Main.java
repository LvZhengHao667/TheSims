        ...
        while (true) {
            ...
            if (user.getActionPoint() <= 0) {
                while (true) {
                    ...
                    System.out.println(" ");
                    System.out.println("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                    System.out.println("You can visit the following places every day.");
            ...
            if (Objects.equals(userGo, "Arcade") || Objects.equals(userGo, "1")) {
                ...
                System.out.println("2.You can choose to play The Arena.This is a turn-based game where players need to construct their teams strategically, select battle rewards wisely, and win more rounds in the arena.");

...
import org.Arcade.TheArena.RunArena;
import org.CarShop.*;
...
public static void main(String[] args) {
    ...
    User user = new User(5, 5, 100000, 10 , userCar);
...
//This loop represents game start and end.
    while (true) {
        ...
        System.out.println("Adjust initial money and health for testing.");
       DetectAnomalies detectAnomalie = new DetectAnomalies();
        user.changeHealth(detectAnomalie.Detect());
       user.changeMoney(detectAnomalie.Detect());
        ...
        System.out.println(" ");
        System.out.println("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.println("You start with 100,000$ and 5 action points per day.");
        ...
        while (true) {
            ...
            //Go into Hospital
                ...
                System.out.println("2. benylin : It restores 2 health point for you.It costs 2000 $");
                System.out.println("3. nurofen : It restores 3 health point for you.It costs 3000 $");
                System.out.println("4. bonjela : It restores 4 health point for you.It costs 4000 $");
                System.out.println("5. rennie : It restores 5 health point for you.It costs 5000 $");

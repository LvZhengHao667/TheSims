...
public class Wizard {
    ...
    public Wizard() {
        ...
        for (int i = 0; i < wizardNumber; i++) {
            name.add("Wizard" + (i + 1) + " ");
            hp.add((int) (20 + roundCounter.getRound() * 4));
            str.add(8 + roundCounter.getRound() * 3);
        ...
        int wizardRandom = r.nextInt(3);
        System.out.println(heroes.name.get(wizardRandom) + " is turned into frog.");
        heroes.name.set(wizardRandom,"frog  ");
            ...
            for (i = 0; i < orderString.size(); i++) {
                ...
                if (!heroes.name.contains(orderString.get(i))) {
                    ...
                    if(guardian.protect && heroes.hp.get(chooseToAttack) == minHp) {
                        ...
                        heroAttacked = heroes.name.get(chooseToAttack);
                    }
                ...
                } else if(!Objects.equals(orderString.get(i), "frog  ")) {
                    ...
                    if(heroes.mp.get(heroes.name.indexOf(orderString.get(i))) != 0){
                        ...
                        opponentAttacked = name.get(chooseToAttack);
                        ...
                        switch (heroes.allName.indexOf(orderString.get(i))){
                            ...
                            case 1: int max = hp.get(0);
                                ...
                                opponentAttacked = name.get(hp.indexOf(max));
                    ...
                    System.out.println("Frog can do nothing");
                    System.out.println(new String(new char[1]).replace("\0", "\r\n"));
                }
                //calculating damage

                for (int j = 0; j < hp.size(); j++) {
                    if(Objects.equals(name.get(j), opponentAttacked)) {
                        System.out.print(RunArena.RED + name.get(j) + RunArena.RESET + " : " + hp.get(j) + "   ");
                    }else{
                ...
                for (int j = 0; j < heroes.hp.size(); j++) {
                    if(Objects.equals(heroes.name.get(j), heroAttacked)) {
                        System.out.println(RunArena.RED + heroes.name.get(j) + RunArena.RESET + " hp : " + heroes.hp.get(j) + "      sp : " + heroes.mp.get(j) + "      atk : " + heroes.str.get(j));
                    }else{

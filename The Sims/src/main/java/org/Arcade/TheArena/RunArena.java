    ...
    public static void RunningArena(User user) {
        ...
        while (!end) {
            if(roundCounter.getRound() == 0) {
                ...
                System.out.println();
                System.out.println("1."+RED+"Paladin"+RESET+": High HP, with the ability to taunt the enemies.");
                System.out.println("2."+RED+"Assassin"+RESET+": High Speed, with the ability to deal percentage damage.");
                System.out.println("3."+RED+"Magician"+RESET+": Has the ability to attack a group enemies at once.");
                System.out.println("4."+RED+"Priest"+RESET+": Has the ability to heal the team.");
                System.out.println("5."+RED+"Guardian"+RESET+": High HP, with the ability to protect the weakest teammate.");
                System.out.println("6."+RED+"Berserker"+RESET+": High attack, with the ability to become stronger in the fight.");
                System.out.println();
            ...
            System.out.println("1." + RED + "goblin" + RESET + ": Weak, but they have huge advantage in numbers.");
            System.out.println("2." + RED + "giant"+ RESET + ": Tough and powerful, but also lonely.");
            System.out.println("3." + RED + "wizard" + RESET + ": He can turn one of your teammate into a frog at the beginning of the fight, and what do you expect a frog will do?");
            System.out.println("4." + RED +"dragon" + RESET + ": The final boss, chose it if you think you are ready.");

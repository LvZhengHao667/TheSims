...
public class Volkswagen {
    public void BuyVolk(User user , Cars car){
        if (user.getMoney() >= car.getValue(2)) {
            while (true) {
                ...
                Scanner confirmBuyVolk = new Scanner(System.in);
                String confirmsBuyVolk = String.valueOf(confirmBuyVolk.nextLine());
                if (Objects.equals(confirmsBuyVolk, "Yes") || Objects.equals(confirmsBuyVolk, "yes") || Objects.equals(confirmsBuyVolk, "Y") || Objects.equals(confirmsBuyVolk, "y")) {
                    user.reduceActionPoint(1);
                    user.reduceMoney(car.getValue(4));
                    user.setInitialActionPoint(4);
                    System.out.println("You get the car!");
                    break;
                }
                else if (Objects.equals(confirmsBuyVolk, "No") || Objects.equals(confirmsBuyVolk, "no") || Objects.equals(confirmsBuyVolk, "N") || Objects.equals(confirmsBuyVolk, "n")) {
            ...
            System.out.println("You do not have enough money! You went home dejectedly.");
        }
    }
    public void SellVolk( User user , Cars car){
